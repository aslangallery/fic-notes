...
**DEFINICIÓN**
****
>Plantillas que permiten crear un diseño común que se comparte entre las diferentes páginas de contenido.
...
Los controladores `ContentPlaceHolder` pueden definir un contenido por defecto. Se muestra únicamente si la página de contenidos no lo sobrescribe.
```csharp
...
****
Se puede crear una página maestra que referencia a otra.
```csharp
//Padre
